...
def create_app(config_class=Config):
    ...
    if should_log_startup:
        logger.info("=" * 50)
        logger.info("BookMiro Backend 启动中...")
        logger.info("=" * 50)
    ...
    @app.before_request
    def log_request():
        logger = get_logger('bookmiro.request')
    ...
    @app.route('/health')
    def health():
        return {'status': 'ok', 'service': 'BookMiro Backend'}
